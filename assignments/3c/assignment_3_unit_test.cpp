...
void UnitTest() {
  ...
  for (int i = 0; i < 970; i++) list.AddItem(new TodoItem("A", 1, true));
  ...
  for (int i = 1000; i >= 1; i--) list.DeleteItem(i);
  ...
  for (int i = 0; i < 50; i++) dynamic_list->AddItem(new TodoItem("testing"));
  delete dynamic_list;
